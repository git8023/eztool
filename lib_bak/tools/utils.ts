...
export namespace utils {
   ...
   */
  export function mergeJson<T>(src: T, dest: T, recover = true): string[] {
   ...
   */
  export function toJson<T>(json: string | any): T {
   ...
   */
  export function toJsonStr(obj: string | any): string {
   ...
   * @return 处理结果
   */
  export function exec<T>(thisArg: any, fn: (...arg: any[]) => any, ...args: any[]): T {
